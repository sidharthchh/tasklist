...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'dw)pc)b@dnzp_hy3ri9d*4@#s_hca(=5f%o0r!i!hw#d6^4gp7')
...
# See .ebextensions/tasklist.config
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'when': 'midnight',
            'backupCount': 10,
            'filename': os.path.join(LOG_DIR, 'tasklist.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
